...
CN_MCI_mid = (CN_mu+MCI_mu)/2
Dementia_MCI_mid = (Dementia_mu+MCI_mu)/2
print(CN_Dementia_mid)

# fig = plt.figure(num=3, clear=True)
# ax = fig.add_subplot(1, 1, 1, projection='3d')

# x = np.array([[-12.4, -1.9], [4.4, -12.4]])
# y = np.array([[1.7, 1.5], [-1.9, 1.7]])
# z = np.array([[6.4, -1.7], [-12.4, -5]])

# x = np.array([[-12.4, -1.9,4.4]])
# y = np.array([[1.7, 1.5,-1.9]])
# z = np.array([[6.4, -1.7,-12.4]])
...
plt3d.set(xlabel='x', ylabel='y', zlabel='z')
