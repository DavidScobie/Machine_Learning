...
np.savetxt('./loss/T7_opti_b135_600_l_h.txt', numpy_loss_history, delimiter=",")
...
json_filename = './jsons/T7_opti_b135_600.json'
weights_filename = './weights/T7_opti_b135_600_w.h5'
