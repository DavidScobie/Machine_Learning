...
json_file = open('./T7_from_cluster/jsons/T7_opti_b135_600.json', 'r') 
loaded_model_json = json_file.read()
json_file.close()
model_T7 = model_from_json(loaded_model_json)
# load weights into new model
model_T7.load_weights('./T7_from_cluster/weights/T7_opti_b135_600_w.h5') 
print("Loaded model from disk")

#Now I want to have the code for T5
...
def my_data_generator(subject_indices):
    for iSbj in subject_indices:
        ...
        if len(relevant_keys) > 1: #case 64 only has 1 frame
            ...
            #Check if the classification model predicts prostate or not
            
            #The T7 data generator
            def my_test_generator_T7():
            ...
            test_dataset_T7 = tf.data.Dataset.from_generator(generator = my_test_generator_T7, 
